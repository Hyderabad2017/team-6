...
<form action="u_cr_term1.php" method="post" enctype="multipart/form-data">
    <h2>Select file for classroom assessment of term 1:</h2><br>
    <input type="file" name="fileToUpload" id="fileToUpload"><br>
    <input type="submit" value="Upload file" name="submit">
</form>
<br><br><br>
<form action="u_cr_term2.php" method="post" enctype="multipart/form-data">
    <h2>Select file for classroom assessment of term 2:</h2><br>
    <input type="file" name="fileToUpload" id="fileToUpload"><br>
    <input type="submit" value="Upload file" name="submit">
</form>
<br><br><br>
<form action="u_cr_term3.php" method="post" enctype="multipart/form-data">
   <h2> Select file for classroom assessment of term 3:</h2><br>
    <input type="file" name="fileToUpload" id="fileToUpload"><br>
    <input type="submit" value="Upload file" name="submit">
</form>
</div>
